        ...
        <div class="col-lg-8">
          <div class="jumbotron bg-warning">
            ...
            <form method="get" action="<?php echo e(route('search')); ?>" class="form-inline my-2 my-lg-0">
              ...
              <input class="form-control mr-sm-2" type="search"name="idCer" placeholder="Search" aria-label="Search">
...
<?php /**PATH C:\xampp\htdocs\test8\resources\views/index.blade.php ENDPATH**/ ?>